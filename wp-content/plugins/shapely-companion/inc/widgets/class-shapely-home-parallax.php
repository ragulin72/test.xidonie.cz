							...
							<div class="<?php echo esc_attr( $class2 ); ?>">
								<div class="<?php echo esc_attr( $class3 ); ?>">
									...
									if ( '' != $instance['body_content'] ) {
										echo '<div class="mb32 text-shadow">';
										echo apply_filters( 'the_content', wp_kses( $instance['body_content'], $allowed_tags ) );
										echo '</div>';
									}
									echo ( '' != $instance['button2'] && '' != $instance['button2_link'] ) ? '<a class="btn btn-lg btn-outline-headpink" href="' . esc_url( $instance['button2_link'] ) . '">' . wp_kses_post( $instance['button2'] ) . '</a>' : '';
